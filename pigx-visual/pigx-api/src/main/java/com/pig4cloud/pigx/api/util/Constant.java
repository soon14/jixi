...
//	public static final String BASE_URL = "https://180.101.147.89:8743";
	...
	/**
     * 公司的平台
     * ID:tn8SzZvVYSOYBXS89YxJRPm7fi4a 秘钥：H3m_LAV6iQk6Uaq94O822Qp8Wjoa
     * ID:94_5PQES9_suLgoRA7qaanKCl9ca 秘钥：gf64fUBoGaeNmfEGOmyDjDWQTf8a
     * 
     */
//    public static final String APPID = "tn8SzZvVYSOYBXS89YxJRPm7fi4a";
//    public static final String SECRET = "CaLlBScUfIrj9KI9kEcLU8dnbzYa";//H3m_LAV6iQk6Uaq94O822Qp8Wjoa
...
//    public static final String SECRET = "b0pcUQYHNHxiaCZm8KQfCUuLo0Aa";
	 ...
	 * 我自己申请的平台
	 */
    //public static final String APPID = "xA9mUTPyIqsVIXHnkuUh55tMN6ka";
    //public static final String SECRET = "MJbj7WqFaqHYTB9wSQjtKL4X5G8a";
    
    /**
     * 正式的平台  xiaofang01应用
     */
    //public static final String APPID = "s8X81NLK2afgGQU2rroKDOgIo5Ua";
    //public static final String SECRET = "HewQgPAAv215PWgDfFTAohhuSYQa";
	
	
	/**
	 * 正式设备接入地址
	 */
	 public static final String BASE_URL = "https://device.api.ct10649.com";
    
    /**
     * 正式的平台  slq01
     * IkiOLXmx6njxzXX6Uv4B19Ndv0ka
     */
    //public static final String APPID = "IkiOLXmx6njxzXX6Uv4B19Ndv0ka";
    //0rprQ65jzZg3NnNYkt46Ub7RBFMa
    //public static final String SECRET = "dBXN6e_G3p5uTBe8MYWuupwiSQAa";
    
    /**
     * 天水2
     * 
     */
	 //public static final String APPID = "cf9s92KE3Lpb1MUEj1haDgr_G_oa";
	//public static final String SECRET = "r74Zzr6DOjqhWHeoAiBkcLWfGq4a";
    /**
     * 正式的平台  lss
     * IkiOLXmx6njxzXX6Uv4B19Ndv0ka
     */
    public static final String APPID = "qPPuGRpnS7Ndvj07xFeqwwqqyL0a";
//    //0rprQ65jzZg3NnNYkt46Ub7RBFMa
    public static final String SECRET = "PSvqX7O2XP2JQGYvEDRJRgB2gVIa";
    /*
    ...
    public static String SELFCERTPATH = /*File.separator+"src"+File.separator+"main"+File.separator+"resources"+File.separator+"static"+*/File.separator+"outgoing.CertwithKey.pkcs12";
    public static String TRUSTCAPATH = /*File.separator+"src"+File.separator+"main"+File.separator+"resources"+File.separator+"static"+*/File.separator+"ca.jks";
     ...
     * 设备注册URL
     */
    public static final String DEVICE_REGISTER = BASE_URL + "/iocm/app/reg/v1.1.0/deviceCredentials";//?appId=+Constant.APPID;
    
    /**
     * 设备删除URL
     */
    public static final String DEVICE_DELETE = BASE_URL + "/iocm/app/dm/v1.4.0/devices/";
    
    /**
     * 修改设备信息URL
     */
    public static final String UPDATE_DEVICE_INFO = BASE_URL;
