...
//		生产环境 linux
		String selfcertpath = /*demo_base_Path + */ "/pigx-device"+Constant.SELFCERTPATH;
		String trustcapath = /*demo_base_Path*/  "/pigx-device"+Constant.TRUSTCAPATH;
		
//		生产环境 windows
		//String selfcertpath = "D:/smoke" +File.separator+"outgoing.CertwithKey.pkcs12";
		//String trustcapath = "D:/smoke" +File.separator+"ca.jks";
		
		//开发环境
//		String localpath = "E:\\workspace\\SmokeFeel\\src\\main\\resources\\static";
//		String selfcertpath = localpath + Constant.SELFCERTPATH;
//		String trustcapath = localpath  + Constant.TRUSTCAPATH;
		...
		caCert.load(new FileInputStream(trustcapath), "Huawei@123".toCharArray());
	...
	public StreamClosedHttpResponse doPostFormUrlEncodedGetStatusLine(
        ...
        //obj.put("appId", "xA9mUTPyIqsVIXHnkuUh55tMN6ka");
        //obj.put("secret", "MJbj7WqFaqHYTB9wSQjtKL4X5G8a");
